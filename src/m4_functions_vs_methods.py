...
def try_methods_and_functions():
    ...
    stooge = rg.SimpleTurtle()
    stooge.pen = rg.Pen('blue', 5)
    stooge.speed = 1

    stooge.backward(150)
    draw_many_squares(stooge, 2, 100, 30)

    stooge.speed = 5
    stooge.pen = rg.Pen('red', 5)
    draw_many_squares(stooge, 10, 50, 15)

    stooge.speed = 100
    stooge.pen = rg.Pen('red', 35)
    draw_many_squares(stooge, 8, 300, 60)

    stooge.pen = rg.Pen('black', 3)

    stooge.backward(200)

    stooge.draw_circle(30)

    stooge.draw_square(50)
