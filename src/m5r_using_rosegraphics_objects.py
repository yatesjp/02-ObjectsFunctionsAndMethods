...
#               windowy = rg.RoseWindow(463528,100)
#
...
#            It draws the window witht the attached shapes/points appearing on it
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            At the end of everything so that there is a non-erroneous way to end the program
#
